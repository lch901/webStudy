...
insert into board_info_table(board_info_idx, board_info_name) values (3, '3寃뚯떆?뙋');
insert into board_info_table(board_info_idx, board_info_name) values (4, '4寃뚯떆?뙋');
